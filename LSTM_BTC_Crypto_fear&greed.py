...
filename = '/Users/paulbergeon/Documents/mémoireESSCA/Sentiment:PrixBTC.csv'
...
look_back = 50
train_X, train_Y = create_dataset(train_data[['Sentiment normalisé', 'Close normalisé']].values, look_back)
test_X, test_Y = create_dataset(test_data[[ 'Sentiment normalisé', 'Close normalisé' ]].values, look_back)

print("Taille de train_X:", train_X.shape)
print("Taille de test_X:", test_X.shape)

model = Sequential()
model.add(LSTM(300, input_shape=(look_back, 2)))
model.add(Dense(1))
